...
namespace Stack.Repository
{
         ...
         where TContext : DbContext
    {
        ...
        public virtual async Task<bool> RemoveListAsync(List<TEntity> entities)
        {
            return await Task.Run(() =>
            {
                if (entities != null && entities.Count > 0)
                {
                    ...
                    // You can check the change tracker for all entities or simply return true here
                    // since you've attempted to remove all entities.
                    return true;
                }
                return false;
            });
